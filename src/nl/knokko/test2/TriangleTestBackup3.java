...
public class TriangleTestBackup3 {
	...
	public static void main(String[] args) {
		...
		TriangleTestBackup3 triTest = new TriangleTestBackup3();
		triTest.run();
	...
	byte[] readFile(String resourceName) {
		try {
			URL url = TriangleTestBackup3.class.getClassLoader().getResource(resourceName);
