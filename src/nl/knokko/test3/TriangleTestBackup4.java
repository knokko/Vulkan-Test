...
public class TriangleTestBackup4 {
	...
	public static void main(String[] args) {
		...
		TriangleTestBackup4 triTest = new TriangleTestBackup4();
		triTest.run();
	...
	byte[] readFile(String resourceName) {
		try {
			URL url = TriangleTestBackup4.class.getClassLoader().getResource(resourceName);
